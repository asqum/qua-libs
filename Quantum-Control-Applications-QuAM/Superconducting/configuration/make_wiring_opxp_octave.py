...
host_ip = "192.168.1.77"  # QOP IP address
port = None  # QOP Port
...
connectivity.add_qubit_drive_lines(qubits=[0], constraints=octave_spec(index=1, rf_out=2))
connectivity.add_qubit_drive_lines(
    qubits=[1], constraints=opx_iq_octave_spec(con=1, out_port_i=7, out_port_q=8, octave_index=1, rf_out=4)
)
connectivity.add_qubit_pair_flux_lines(qubit_pairs=[(0,1)])  # Tunable coupler
