...
class Parameters(NodeParameters):
    ...
    control_qubit_post_cz_phase_corrections: List[float] = [0.880, 0.484, 0.384, -0.278] #None
    target_qubit_post_cz_phase_corrections: List[float] = [-0.404, 0.374, 0.449, -0.830] #None
