...
g = QualibrationGraph(
    ...
    nodes={
        ...
        "ramsey_flux_calibration": library.nodes["06a_Ramsey_vs_Flux_Calibration"].copy(
            flux_point_joint_or_independent="independent", multiplexed=multiplexed, num_averages=120, frequency_detuning_in_mhz = 4.0,
            min_wait_time_in_ns= 16, max_wait_time_in_ns= 1016, wait_time_step_in_ns = 10, flux_span= 0.008, flux_step = 0.0001
        ),
        ...
        "power_rabi_x180": library.nodes["09_Power_Rabi_State"].copy(
        ...
        "power_rabi_x90": library.nodes["09_Power_Rabi_State"].copy(
