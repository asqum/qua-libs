...
class Parameters(NodeParameters):
    ...
    coupler_flux_min : float = -0.093 #relative to the coupler set point
    """Minimum of the coupler flux sweep"""
    coupler_flux_max : float =  -0.065 #relative to the coupler set point
    """Maximum of the coupler flux sweep"""
    coupler_flux_num_points : int = 51
    """Length of the flux sweep for coupler fluxes."""    
    qubit_flux_min: float = -0.003  #relative to the qubit pair detuning
    """Minimum of the qubit flux sweep"""
    qubit_flux_max: float = 0.009  #relative to the qubit pair detuning
