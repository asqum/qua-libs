...
if not node.parameters.simulate:
    ...
    node.results["results"]["coupler_q1_q2"] = {"flux_coupler_Cz": 0.2353, "flux_qubit_Cz": 0.0719}
    node.results["results"]["coupler_q2_q3"] = {"flux_coupler_Cz": 0.2415, "flux_qubit_Cz": 0.079}
