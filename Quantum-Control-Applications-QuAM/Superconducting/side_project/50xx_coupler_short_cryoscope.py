...
from calibration_utils.cryoscope.analysis import unwrap_phase, fit_oscillation, cryoscope_frequency, optimize_start_fractions, _extract_relevant_fit_parameters
...
def fit_raw_data(ds: xr.Dataset, node: QualibrationNode):
    ...
    qubit = node.machine.qubit_pairs[qubit_name]

    ds_fit = cryoscope_frequency(
        daphi,
        quad_term=float(qubit.coupler.extras["Fx"]["freq_vs_flux_01_quad_term"]),
