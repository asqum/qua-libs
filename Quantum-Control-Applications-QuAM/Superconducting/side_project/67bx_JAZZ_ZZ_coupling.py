...
What's the differences with node 67b:
- Flux range in (-span/2, +span/2) to chen the zero point is at the center of the x-axis.
- x-axis is the flux amplitude. (doesn't reset the coupler bias to 0.)
