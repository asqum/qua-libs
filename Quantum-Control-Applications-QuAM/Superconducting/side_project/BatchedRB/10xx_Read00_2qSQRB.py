"""
    SINGLE QUBIT SIMULTANEOUS RB, READ |00> STATE.

Single qubit simultaneous RB read |00> to compute an single qubit Clifford gate fidelity.

Prerequisites:
    - active reset works good.
    - readout IQ blobs calibrated.

Warning:
    - This program will run a large number of random circuits and it's really time consuming. 50 random circuits per depth takes around 2000 seconds. Please adjust the number of random circuits according to your needs and time budget.
"""
