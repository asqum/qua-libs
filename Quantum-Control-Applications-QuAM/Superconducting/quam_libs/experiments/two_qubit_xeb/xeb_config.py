...
class XEBConfig:
    ...
    Args:
        ...
        qubit_pairs_ids (List[Union[int, str]]): List of qubit pair identifiers for the targeted qubit pairs as specified in the QuAM
    ...
    two_qb_gate: Optional[QUAGate] = None #(None,)
